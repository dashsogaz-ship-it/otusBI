...
Unauthorized access is brohibited!!!
...
Вопрос:
Какие версии протокола SSH поддерживаются при использовании интерфейса командной строки? SSH ver 1 и ver 2

	Вопрос для повторения
Как предоставить доступ к сетевому устройству нескольким пользователям, у каждого из которых есть собственное имя пользователя?
Доступ можно предоставить через локальную базу учётных записей, добавив их логины и пароли.
