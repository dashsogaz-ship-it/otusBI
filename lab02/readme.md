...
Дополнительные записи появились для всех устройств.
```
C:\>arp -a
  Internet Address      Physical Address      Type
  192.168.1.1           0002.4a96.a266        dynamic
  192.168.1.11          000a.41cb.4328        dynamic
  192.168.1.12          000a.4122.6a33        dynamic
```

№№ 	Вопрос для повторения

Могут возникнуть проблемы с производительностью и стабильностью из-за роста объёма трафика.
